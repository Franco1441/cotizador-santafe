...
export default function puertonuevo() {
  ...
  const handleEnviar = async (e) => {
    ...
    try {
      const doc = new jsPDF();
      const logoBlob = await fetch("/dellasanta.png").then((res) => res.blob());
      ...
      doc.addImage(logoBase64, "PNG", 90,22, 28, 8);
      doc.setFontSize(10);
    ...
    <div className="min-h-screen bg-white text-gray-800 px-4 py-8">
      <div className="max-w-xl mx-auto">
        <header className="mb-6 text-center">
          <img src="/dellasanta.png" alt="Dellasanta" className="mx-auto h-12 mb-3" />
        </header>
        ...
        >
          <h2 className="text-xl font-semibold text-[#091452] mb-3">
              ...
              {["masculino", "femenino"].map((s) => (
                <label
                  ...
                  className={`px-3 py-2 rounded-lg border cursor-pointer ${
                    sexo === s ? "border-[#091452] bg-[#00aeff19]" : "border-gray-200"
                  }`}
                >
                  <input
                    type="radio"
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <input
                ...
                className="flex-1 accent-[#00aeff]"
              />
            ...
            <div className="flex gap-4">
              {["ARS", "USD"].map((m) => (
                <label
                  key={m}
                  className={`px-3 py-2 rounded-lg border cursor-pointer ${
                    moneda === m ? "border-[#091452] bg-[#00aeff19]" : "border-gray-200"
                  }`}
                >
                  <input
                    type="radio"
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full accent-[#00aeff] mt-1"
            />
            <div className="text-right text-medium font-medium text-[#091452]">
          ...
          <div className="text-center mt-4">
            <button
              ...
              className="inline-block px-6 py-2 rounded-full bg-[#091452] text-[#ffffff] font-semibold hover:brightness-95"
            >
              Calcular
            </button>
          </div>
        ...
        {resultado && (
          <motion.div ref={resultadoRef} initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-6 space-y-4">
            ...
            <div className="bg-[#091452] p-4 rounded-lg border">
            ...
            <form onSubmit={handleEnviar} className="bg-white border rounded-2xl p-4 shadow-sm">
              ...
              <div className="mt-3 flex justify-end">
                <button type="submit" disabled={sending} className="px-5 py-2 bg-[#091452] text-[#ffffff] rounded-full">
