...
export default function Fallabrino() {
...
trackEvent("simulacion_realizada", {
  ...
  const handleEnviar = async (e) => {
    ...
    try {
      const doc = new jsPDF();
      const logoBlob = await fetch("/logo-fallabrino.png").then((res) => res.blob());
      ...
      doc.addImage(logoBase64, "PNG", 90, 13, 21, 20);
      doc.setFontSize(10);
    ...
    <div className="min-h-screen bg-white text-gray-800 px-4 py-8">
      <div className="max-w-xl mx-auto">
        <header className="mb-6 text-center">
          <img src="/logo-fallabrino.png" alt="Fallabrino" className="mx-auto h-24 mb-3" />
        </header>
        ...
        >
          <h2 className="text-xl font-semibold text-[rgb(0,53,123)] mb-3">
              ...
              {["masculino", "femenino"].map((s) => (
                <label
                  ...
                  className={`px-3 py-2 rounded-lg border cursor-pointer ${
                    sexo === s ? "border-[#00357b] bg-[#aec4e0]" : "border-gray-200"
                  }`}
                >
                  <input
                    type="radio"
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <input
                ...
                className="flex-1 accent-[#de0043]"
              />
            ...
            <div className="flex gap-4">
              {["ARS", "USD"].map((m) => (
                <label
                  key={m}
                  className={`px-3 py-2 rounded-lg border cursor-pointer ${
                    moneda === m ? "border-[#00357b] bg-[#aec4e0]" : "border-gray-200"
                  }`}
                >
                  <input
                    type="radio"
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full accent-[#de0043] mt-1"
            />
          ...
          <div className="text-center mt-4">
            <button
              ...
              className="inline-block px-6 py-2 rounded-full bg-[#00357b] text-white font-semibold hover:brightness-95"
            >
              Calcular
            </button>
          </div>
        ...
        {resultado && (
          <motion.div ref={resultadoRef} initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-6 space-y-4">
            ...
            <div className="bg-[#00357b] p-4 rounded-lg border">
            ...
            <form onSubmit={handleEnviar} className="bg-white border rounded-2xl p-4 shadow-sm">
              ...
              <div className="mt-3 flex justify-end">
                <button type="submit" disabled={sending} className="px-5 py-2 bg-[#00357b] text-white rounded-full">
