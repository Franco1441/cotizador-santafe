...
trackEvent("simulacion_realizada", {
  ...
  const handleEnviar = async (e) => {
    ...
    try {
      // === Generar PDF ===
      const doc = new jsPDF();
      const logoBlob = await fetch("/Ferrari.png").then((res) => res.blob());
      ...
      doc.addImage(logoBase64, "PNG", 80, 10, 48, 28);
      doc.setFontSize(10);
      ...
      autoTable(doc, {
        ...
        headStyles: { fillColor: [25, 66, 137] },
      });
    ...
    <div className="min-h-screen bg-white text-gray-800 px-4 py-8">
      <div className="max-w-xl mx-auto">
        <header className="mb-6 text-center">
          <img src="/Ferrari.png" alt="Prevención Retiro" className="mx-auto h-24 mb-2" />
        </header>
        ...
        >
          <h2 className="text-xl font-semibold text-[#194289] mb-3">
              ...
              {["masculino", "femenino"].map((s) => (
                <label
                  ...
                  className={`px-3 py-2 rounded-lg border cursor-pointer ${
                    sexo === s ? "border-[#194289] bg-[#deeaff]" : "border-gray-200"
                  }`}
                >
                  <input
                    type="radio"
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <input
                ...
                className="flex-1 accent-[#bd9b5f]"
              />
            ...
            <div className="flex gap-4">
              {["ARS", "USD"].map((m) => (
                <label
                  key={m}
                  className={`px-3 py-2 rounded-lg border cursor-pointer ${
                    moneda === m ? "border-[#194289] bg-[#deeaff]" : "border-gray-200"
                  }`}
                >
                  <input
                    type="radio"
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full accent-[#bd9b5f] mt-1"
            />
            <div className="text-right text-medium font-medium text-[#194289]">
          ...
          <div className="text-center mt-4">
            <button
              ...
              className="inline-block px-6 py-2 rounded-full bg-[#194289] text-white font-semibold hover:brightness-95"
            >
              Calcular
            </button>
          </div>
        ...
        {resultado && (
          ...
          >
            ...
            <div className="bg-[#194289] p-4 rounded-lg border">
              <div className="text-sm text-[#bd9b5f]">Capital al retiro</div>
            ...
            <div className="bg-[#194289] p-4 rounded-lg border">
              <div className="text-sm text-[#bd9b5f]">Renta mensual proyectada</div>
              <div className="text-2xl font-bold text-[#ffffff]">
            ...
            <form onSubmit={handleEnviar} className="bg-white border rounded-2xl p-4 shadow-sm">
              ...
              <div className="mt-3 flex justify-end">
                <button
                  type="submit"
                  disabled={sending}
                  className="px-5 py-2 bg-[#194289] text-white rounded-full"
                >
