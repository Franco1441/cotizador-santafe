...
export default function SilvinaRojas() {
  ...
  const handleEnviar = async (e) => {
    ...
    try {
      const doc = new jsPDF();
      const logoBlob = await fetch("/silvinarojas-logo.jpeg").then((res) => res.blob());
      ...
      doc.addImage(logoBase64, "JPEG", 95, 12, 20, 20);
      doc.setFontSize(10);
      ...
      autoTable(doc, {
        ...
        headStyles: { fillColor: [173, 16, 79] },
      });
    ...
    <div className="min-h-screen bg-white text-gray-800 px-4 py-8">
      <div className="max-w-xl mx-auto">
        <header className="mb-6 text-center">
          <img src="/silvinarojas-logo.jpeg" alt="Silvina Rojas" className="mx-auto h-24 mb-3" />
        </header>
        ...
        >
          <h2 className="text-xl font-semibold text-[#ad104f] mb-3">
              ...
              {["masculino", "femenino"].map((s) => (
                <label
                  ...
                  className={`px-3 py-2 rounded-lg border cursor-pointer ${
                    sexo === s ? "border-[#ad104f] bg-[#f8e4ed]" : "border-gray-200"
                  }`}
                >
                  <input
                    type="radio"
            ...
            <div className="flex gap-4">
              {["ARS", "USD"].map((m) => (
                <label
                  key={m}
                  className={`px-3 py-2 rounded-lg border cursor-pointer ${
                    moneda === m ? "border-[#ad104f] bg-[#f8e4ed]" : "border-gray-200"
                  }`}
                >
                  <input
                    type="radio"
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full accent-[#d22b6f] mt-1"
            />
            <div className="text-right text-medium font-medium text-[#ad104f]">
          ...
          <div className="text-center mt-4">
            <button
              ...
              className="inline-block px-6 py-2 rounded-full bg-[#ad104f] text-[#ffffff] font-semibold hover:brightness-95"
            >
              Calcular
            </button>
          </div>
        ...
        {resultado && (
          <Motion.div ref={resultadoRef} initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-6 space-y-4">
            ...
            <div className="bg-[#ad104f] p-4 rounded-lg border border-[#ad104f]">
              <div className="text-sm text-[#ffffff]">Capital al retiro</div>
            ...
            <div className="bg-[#ad104f] p-4 rounded-lg border border-[#ad104f]">
              <div className="text-sm text-[#ffffff]">Renta mensual proyectada</div>
              <div className="text-2xl font-bold text-[#ffffff]">
            ...
            <form onSubmit={handleEnviar} className="bg-white border rounded-2xl p-4 shadow-sm">
              ...
              <div className="mt-3 flex justify-end">
                <button type="submit" disabled={sending} className="px-5 py-2 bg-[#ad104f] text-[#ffffff] rounded-full">
